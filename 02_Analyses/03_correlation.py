...
big_inc_corr = corr_df.loc[corr_df['30 -> 40']]['Delta'].mean()
rest_inc_corr = corr_df.loc[corr_df['Type'] == 'Included'].loc[corr_df['30 -> 40'] == False]['Delta'].mean()
total_inc_corr = corr_df.loc[corr_df['Type'] == 'Included']['Delta'].mean()
ex_corr = corr_df.loc[corr_df['Type'] == 'Excluded']['Delta'].mean()
result_df = pd.DataFrame([total_inc_corr, big_inc_corr, rest_inc_corr,ex_corr])
result_df = result_df.T.rename(index={0: 'Avg. Correlation'})
result_df.columns = ['Included', 'Included 40', 'Included others', 'Excluded']
